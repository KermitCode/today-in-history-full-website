...
<div id="contents" style="background:url('/images/mainbg.gif');"> 
<div class="mainbar">
	<?php echo $content; ?>
    </div>

<div class="sidebar">
	<div id="change"><a href="<?php echo $this->webset['web_url'].$this->createUrl('site/index',array('lay'=>$this->lay==1?0:1));?>"><img src="<?php echo $this->baseurl; ?>images/change.gif" alt="<?php echo $this->pagestips['layout'];?>" /></a></div>
	<div class="rili">
    	<div class="mess"><?php 
		if(BAN_LANGUAGE=='chinese') echo date('公元Y年').$this->month.'月';
		else echo date('Y	').$this->showMonth->getMonthname($this->month);?></div>
        <div class="day"><?php echo $this->day;?></div>
    ...
    <div class="rigmain gadget">
     <h2 class="star">
     	<span class="left special">>><?php echo $this->pagestips['ghrq'];?></span>
